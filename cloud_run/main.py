...
from app.config import AVAILABLE_MODELS, DEFAULT_MODEL_ID, DEFAULT_PORT, GEMINI_API_KEY, get_gemini_api_key
from app.gemini_client import GeminiClient

app = FastAPI(
    title="Gemini Web Chatbot (Cloud Run)",
    description="Google Cloud Run 기반 Gemini 3.8 / 3.7 Flash 웹 챗봇 서비스",
    version="1.0.0"
)
...
if __name__ == "__main__":
    ...
    print(f"Starting Gemini Chatbot on Cloud Run (Port: {port})")
